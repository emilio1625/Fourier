...
\subsection{El rectificador de onda }
...
\indent Existen dos tipos principales de rectificadores, el rectificador de media onda y el de onda completa. Este ultimo presenta la ventaja de \\
